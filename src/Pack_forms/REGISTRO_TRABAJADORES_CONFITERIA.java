 ...
 * @author User
 */
public class REGISTRO_TRABAJADORES_CONFITERIA extends javax.swing.JFrame {
    ...
    private void EnviarFichero(){
        ...
        try{
            ...
            //crear el archivo
            fw = new FileWriter("D:\\PROYECTO_TECPRO\\src\\Data\\TrabajadoresConfiteria.txt", true);
            //escribir el archivo
    ...
    public REGISTRO_TRABAJADORES_CONFITERIA() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(REGISTRO_TRABAJADORES_CONFITERIA.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new REGISTRO_TRABAJADORES_CONFITERIA().setVisible(true);
            }
        });
    }
